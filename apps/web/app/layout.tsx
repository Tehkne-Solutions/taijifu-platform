  ...
  return <html lang="pt-BR"><body><div className="shell">
    <header className="topbar">
      ...
      <nav className="nav" aria-label="Navegação principal">
        <a href="/manifesto">Manifesto</a><a href="/canon">Canon</a><a href="/metodo">Método</a><a href="/conhecimento">Conhecimento</a><a href="/glossario">Glossário</a><a href="/referencias">Referências</a>
      </nav>
