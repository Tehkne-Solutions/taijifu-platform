  ...
  return <html lang="pt-BR"><body><div className="shell">
    <header className="topbar">
      ...
      <nav className="nav" aria-label="Navegação principal">
        ...
        <a href="/canon#faixas">Faixas</a>
        <a href="/canon#caminhos">Caminhos</a>
        <a href="/glossario">Glossário</a>
      </nav>
    </header>
    {children}
    <footer className="footer"><span>TAIJIFU-CANON-1.0 · Fonte Oficial</span><strong>Tehkné Solutions</strong></footer>
  </div></body></html>;
}
